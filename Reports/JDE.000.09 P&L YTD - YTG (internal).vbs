...
Dim Period As Long, wkbTemplate As Workbook, wksValidatie As Worksheet, plan As String, ref1 As String, ref2 As String, ref3 As String
...
AddDataSheets "ref3", ref3, entity, wksData
...
Function GetDBData(ByVal sql As String) As Variant
    Dim pw As String, dbConnection As Object, rst As Object, vResult As Variant

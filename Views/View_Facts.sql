SELECT [a.101_salesreturnsoffinvtas] 
       ...
       a.sellingfield + a.sellingoffice                        AS Selling, 
       a.marketing + a.randd + a.centraldesign 
       + a.finance + a.strategy + a.hr + a.communication 
       + a.it + a.legal + a.generalmanagement 
       + a.operations                                          AS OtherSGA, 
       selling + othersga                                      AS OSA, 
       cm + osa                                                AS Ebit, 
